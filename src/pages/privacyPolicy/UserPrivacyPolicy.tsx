        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-8 px-4">
            <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-red-700 to-amber-900 p-8 text-center">
                    ...
                    <p className="text-red-100">Last updated: {new Date().toLocaleDateString()}</p>
                </div>
                ...
                <div className="p-6 md:p-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700 leading-relaxed">
                            Welcome to <span className="font-semibold text-amber-900">MeatExpress</span>, your trusted meat delivery service. We are committed to protecting
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="border border-gray-200 rounded-lg p-6">
                            ...
                            <p className="text-gray-700">
                                To exercise these rights, contact us at <span className="text-amber-900 font-medium">privacy@meatexpress.com</span>
                            </p>
                        </div>
                    ...
                    <div className="mt-8 p-6 bg-amber-50 border border-amber-200 rounded-lg">
                        ...
                        <div className="mt-4 space-y-2">
                            ...
                            <p className="text-gray-700 flex items-center">
                                ...
                                Address: 123 Meat Street, Food District, City, State 12345
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200 text-center">
                        <p className="text-gray-600 text-sm">
                            By using MeatExpress services, you acknowledge that you have read and understood
