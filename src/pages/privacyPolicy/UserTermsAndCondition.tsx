                ...
                <div className="p-6 md:p-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700 mb-4">
                            Welcome to <span className="font-semibold text-amber-900">MeatExpress</span>. These Terms and Conditions govern your use of our meat delivery service and website. By accessing or using our service, you agree to be bound by these Terms.
                        </p>
                        <p className="text-gray-700 mb-4">
                            MeatExpress provides fresh meat, poultry, eggs, and related products through our online platform and delivery service. These Terms apply to all users of the service, including without limitation users who are browsers, vendors, customers, merchants, and/or contributors of content.
                        </p>
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700 mb-4">
                            To access and use certain features of MeatExpress, you may be required to register for an account. You must be at least 18 years old to create an account.
                        </p>
                        ...
                        <p className="text-gray-700">
                            MeatExpress reserves the right to remove or reclaim any usernames at its sole discretion. You acknowledge that MeatExpress is not liable for any losses caused by any unauthorized use of your account.
                        </p>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700 mb-4">
                            MeatExpress's liability is limited to the maximum extent permitted by law. We are not liable for any indirect, incidental, special, consequential, or punitive damages.
                        </p>
                        <div className="bg-amber-50 p-4 rounded-lg mb-4">
                        ...
                        <p className="text-gray-700">
                            You agree to properly handle, store, and cook all products according to food safety guidelines. MeatExpress is not responsible for any illness or injury resulting from improper handling, storage, or preparation of products.
                        </p>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700 mb-4">
                            You agree to use MeatExpress services only for lawful purposes and in accordance with these Terms. You agree not to use our services:
                        </p>
                        <div className="bg-amber-50 p-4 rounded-lg mb-4">
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200">
                        <div className="bg-red-50 p-4 rounded-lg">
                            ...
                            <p className="text-gray-700">
                                By using MeatExpress services, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions. If you do not agree to these Terms, you may not use our services.
                            </p>
                        </div>
                    </div>
                </div>
