        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-800">
              Manager Panel - Priya Fresh Meats
            </h1>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-lg p-6 text-white">
              ...
              <p className="text-red-100 mb-4">
                Display real-time orders on TV screen for stores
              </p>
              <Link
          ...
          <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <ul className="text-yellow-700 space-y-1">
              <li>• Click "Open TV Screen" to view the full-screen live orders display</li>
                              <li>• The TV screen is designed for stores to monitor orders in real-time</li>
