                ...
                <div className="p-6 md:p-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700 mb-4">
                            Welcome to <span className="font-semibold text-amber-900">MeatExpress</span>'s Delivery Partner Privacy Policy. This policy explains how we collect, use, and protect the personal information of our delivery partners.
                        </p>
                        <p className="text-gray-700 mb-4">
                        ...
                        <div className="bg-amber-50 p-4 rounded-lg mb-4">
                            ...
                            <ul className="list-disc pl-5 text-gray-700 space-y-1">
                                <li>This policy applies to all delivery partners registered with MeatExpress</li>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="bg-amber-50 p-4 rounded-lg">
                            ...
                            <ul className="list-disc pl-5 text-gray-700 space-y-1">
                                ...
                                <li>To protect the rights, property, or safety of MeatExpress, our users, or the public</li>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="bg-amber-50 p-4 rounded-lg mb-4">
                            ...
                            <ul className="list-disc pl-5 text-gray-700 space-y-2">
                                <li>
                                    <strong>Email:</strong> delivery-privacy@meatexpress.com
                                </li>
                                <li>
                                    <strong>Phone:</strong> +1 (555) 123-DLVR
                                </li>
                                <li>
                                    <strong>Address:</strong> MeatExpress Delivery Support, 123 Logistics Avenue, Distribution District, City, State 12345
                                </li>
                                <li>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200">
                        <div className="bg-amber-100 p-4 rounded-lg">
                            ...
                            <p className="text-gray-700">
                                By using the MeatExpress delivery partner platform, you acknowledge that you have read and understood this Privacy Policy and agree to the collection, use, and sharing of your information as described herein.
                            </p>
                        </div>
                    </div>
                </div>
