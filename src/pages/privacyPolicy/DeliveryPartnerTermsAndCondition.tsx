        ...
        <div className="min-h-screen bg-gradient-to-b from-amber-50 to-amber-100 py-8 px-4">
            <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-amber-700 to-amber-900 p-8 text-center">
                    ...
                    <p className="text-amber-200 mt-2">For delivery partners of MeatExpress</p>
                </div>
                ...
                <div className="p-6 md:p-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700 mb-4">
                            Welcome to <span className="font-semibold text-amber-900">MeatExpress</span>'s Delivery Partner Terms and Conditions. These terms govern your relationship with MeatExpress as a delivery partner and outline your rights and responsibilities.
                        </p>
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700">
                            MeatExpress reserves the right to verify all provided documentation and conduct additional checks as necessary. We may refuse service to anyone at our sole discretion.
                        </p>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="bg-amber-50 p-4 rounded-lg mb-4">
                            ...
                            <ul className="list-disc pl-5 text-gray-700 space-y-1">
                                ...
                                <li>MeatExpress will provide necessary tax documentation (e.g., 1099 forms)</li>
                            </ul>
                        </div>
                        <p className="text-gray-700">
                            MeatExpress reserves the right to adjust compensation rates with prior notice. Deductions may be made for lost or damaged products attributable to delivery partner negligence.
                        </p>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="bg-amber-50 p-4 rounded-lg mb-4">
                            <h3 className="font-semibold text-amber-900 mb-2">Provided by MeatExpress:</h3>
                            <ul className="list-disc pl-5 text-gray-700 space-y-1">
                        ...
                        <p className="text-gray-700">
                            You agree to return all MeatExpress property upon termination of our agreement. Fees may be charged for unreturned or damaged equipment.
                        </p>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700">
                            You are responsible for all vehicle-related expenses including fuel, maintenance, insurance, and repairs. MeatExpress is not liable for any vehicle-related incidents that occur during delivery activities.
                        </p>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700">
                            MeatExpress maintains commercial general liability insurance, but this does not cover your personal vehicle or injuries you may sustain while performing deliveries. You are encouraged to obtain appropriate additional coverage.
                        </p>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700 mb-4">
                            As a delivery partner, you are an independent contractor, not an employee of MeatExpress. This relationship has important implications:
                        </p>
                        <div className="bg-amber-50 p-4 rounded-lg mb-4">
                            <ul className="list-disc pl-5 text-gray-700 space-y-1">
                                ...
                                <li>MeatExpress does not provide benefits such as health insurance or paid time off</li>
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700 mb-4">
                            During your engagement with MeatExpress, you may have access to confidential information including:
                        </p>
                        <div className="bg-amber-50 p-4 rounded-lg mb-4">
                            <ul className="list-disc pl-5 text-gray-700 space-y-1">
                        ...
                        <p className="text-gray-700">
                            You agree to maintain the confidentiality of this information during and after your engagement with MeatExpress. Unauthorized disclosure may result in termination and legal action.
                        </p>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700">
                            Upon termination, you must return all MeatExpress property and cease using all platform access. Outstanding payments will be processed according to our standard payment schedule.
                        </p>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700 mb-4">
                            MeatExpress's liability to you as a delivery partner is limited as follows:
                        </p>
                        <div className="bg-amber-50 p-4 rounded-lg mb-4">
                            <ul className="list-disc pl-5 text-gray-700 space-y-1">
                        ...
                        <p className="text-gray-700">
                            You agree to indemnify and hold harmless MeatExpress from any claims arising from your delivery activities, except where directly caused by our gross negligence.
                        </p>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <div className="bg-amber-50 p-4 rounded-lg mb-4">
                            ...
                            <ul className="list-disc pl-5 text-gray-700 space-y-1">
                                <li>These Terms are governed by the laws of the state where MeatExpress is headquartered</li>
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700 mb-4">
                            MeatExpress may modify these Terms and Conditions from time to time. Changes will be:
                        </p>
                        <div className="bg-amber-50 p-4 rounded-lg mb-4">
                            <ul className="list-disc pl-5 text-gray-700 space-y-1">
                    ...
                    <div className="mb-8">
                        ...
                        <div className="bg-amber-50 p-4 rounded-lg mb-4">
                            ...
                            <ul className="list-disc pl-5 text-gray-700 space-y-2">
                                ...
                                <li>
                                    <strong>Address:</strong> MeatExpress Delivery Operations, 123 Logistics Avenue, Distribution District, City, State 12345
                                </li>
                                <li>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200">
                        <div className="bg-amber-100 p-4 rounded-lg">
                            ...
                            <p className="text-gray-700">
                                By registering as a delivery partner and using the MeatExpress platform, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions. You affirm that you meet all eligibility requirements and will comply with all provisions outlined herein.
                            </p>
                        </div>
                    </div>
                </div>
