...
// const MeetCenterDisplay: React.FC = () => {
...
//     navigate("/meet-center/edit", { state: {
//     name: row.name,
...
//                 {value === 'active' ? (
//                   <svg
//                     className="w-2 h-2 mr-2 text-green-500"
//                     fill="currentColor"
//                     viewBox="0 0 8 8"
//                   >
...
//                 ) : (
//                   <svg
//                     className="w-2 h-2 mr-2 text-red-500"
//                     fill="currentColor"
//                     viewBox="0 0 8 8"
//                   >
//                     <circle cx={4} cy={4} r={3} />
...
//                   <span className="ml-1 hidden md:inline">Disable</span>
//                 </>
//               ) : (
//                 <>
//                   <ToggleOnIcon fontSize="small" />
//                   <span className="ml-1 hidden md:inline">Enable</span>
//                 </>
//               )}
//             </button>
//           </div>
...
//               {/* <p className="text-sm text-gray-500 mt-1">Manage your retail store network</p> */}
//             </div>
//             <NavigateBtn
//               to="/meet-center/add"
//               label={
...
//             <div className="relative flex-1"> <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
...
// export default MeetCenterDisplay;
